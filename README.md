...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                        | ♦ [ChitChat](https://github.com/aniketsinha2002/ChitChat) (on Progress) <br>  ♦ [NetflixGPT](https://github.com/aniketsinha2002/NetflixGPT) with Auth. (BIG PROJECT)🚀                          | ♦ MERN, Socket.IO, Postman <br> ♦ React, Gemini API, Firebase, Tailwind
