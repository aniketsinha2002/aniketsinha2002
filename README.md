...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                        |  <!-- ♦ [ChitChat](https://github.com/aniketsinha2002/ChitChat) (on Progress) <br> -->  ♦ [NetflixPlus](https://github.com/aniketsinha2002/NetflixGPT)🍿                      | <!-- ♦ MERN, Socket.IO, Postman <br> --> ♦ React, Redux, TMDb API, Gemini API, Firebase, Tailwind
