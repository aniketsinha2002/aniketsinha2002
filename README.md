...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                        | ♦ [ChitChat](https://github.com/aniketsinha2002/ChitChat) <br>  ♦ [NetflixGPT](https://github.com/aniketsinha2002/NetflixGPT) with Auth. (BIG PROJECT)🚀                          | ♦ React, Node, Express, Socket.IO, Postman, MongoDB <br> ♦ React, Gemini API, Firebase, Tailwind
