...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                            |    ♦ [NetflixPlus](https://github.com/aniketsinha2002/NetflixGPT)🍿 <br> ♦ [100xDevs](https://github.com/aniketsinha2002/100xDevs)🚀                     |  ♦ React, Redux, TMDb API, Gemini API, Firebase, Tailwind <br> ♦ NodeJS, ExpressJS, MongoDB, JWT, Zod
