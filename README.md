...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                        |  <!-- ♦ [ChitChat](https://github.com/aniketsinha2002/ChitChat) (on Progress) <br> -->  ♦ [NetflixPlus](https://github.com/aniketsinha2002/NetflixGPT)🍿 on progress                      | <!-- ♦ MERN, Socket.IO, Postman <br> --> ♦ React, Redux, TMDb API, Firebase, Tailwind
