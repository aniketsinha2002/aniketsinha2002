...
|--------------------------                     |-------------------------------------------------------                                                | ---------------
| **Full-Stack Dev**                            |    ♦ [NetflixPlus](https://github.com/aniketsinha2002/NetflixGPT)🍿 <br> ♦ [100xDevs - BUILD IN PUBLIC](https://github.com/aniketsinha2002/100xDevs)🚀                     |  ♦ React, Redux, TMDb API, Gemini API, Firebase, Tailwind <br> ♦ NodeJS, ExpressJS, MongoDB, JWT, Zod, REST APIs, React, Recoil 
